...
class MeasurementsControllerTest < ActionController::TestCase
  ...
  test "should create measurement" do
    assert_difference('Measurement.count') do
      post :create, measurement: { datatype: @measurement.datatype, description: @measurement.description, name: @measurement.name }
    end
  ...
  test "should update measurement" do
    patch :update, id: @measurement, measurement: { datatype: @measurement.datatype, description: @measurement.description, name: @measurement.name }
    assert_redirected_to measurement_path(assigns(:measurement))
  end
